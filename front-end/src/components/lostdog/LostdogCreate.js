    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop: '200px' }}>
            ...
            <div >
                ...
                <div>   
                    <label htmlFor='age'> 나 이 </label><input id='age' type="number" onChange={changeAge}/>
                </div>
                <div>
            ...
            <div>
                ...
                <div>
                    <label htmlFor='status'> 상 태 </label><input id='status' value="lost" type="text"/>
                </div>
            ...
            <button onClick={Create} style={{width : '100px', height : '100px'}}>분실견 추가하기</button>
        </div>
    );
};
